...
\033[1;31m.Brother  : 𝐀𝐍𝐈𝐋 𝐈𝐍𝐒𝐈𝐃𝐄 | 𝐀𝐘𝐀𝐍𝐒𝐇 𝐇𝐄𝐑𝐄   |
 \033[1;36mGithub    : 𝐊𝐇𝐔𝐍𝐈 𝐊𝐈 𝐁𝐇𝐄𝐍 𝐊𝐈 𝐗𝐇𝐔𝐓 𝐊𝐎 𝐂𝐇𝐈𝐑𝐍𝐄 𝐖𝐀𝐋𝐀 𝐓𝐎𝐎𝐋     |
 \033[1;32m.Facebook  :𝐊𝐇𝐔𝐍𝐈 𝐊𝐈 𝐁𝐇𝐄𝐍 𝐊𝐈 𝐆𝐀𝐍𝐃 𝐊𝐈 𝐍𝐀𝐒 𝐅𝐀𝐃𝐍𝐄 𝐖𝐀𝐋𝐀 𝐀𝐍𝐈𝐋 𝐇𝐄𝐑𝐄
 \033[1;34mTool Name : 𝐊𝐇𝐔𝐍𝐈 𝐊 𝐀𝐋𝐋 𝐏𝐈𝐋𝐄 𝐊𝐈 𝐁𝐇𝐄𝐍 𝐊𝐎 𝐗𝐇𝐎𝐃𝐍𝐄 𝐖𝐀𝐋𝐀 𝐀𝐒𝐇𝐈𝐐 𝐀𝐍𝐈𝐋 𝐒𝐏𝐌   |
...
\033[1;32m【𝐊𝐇𝐔𝐍𝐈 𝐊𝐈 𝐁𝐇𝐄𝐍 𝐊𝐈 𝐗𝐇𝐔𝐓 𝐌𝐄 𝐔𝐍𝐆𝐋𝐈 𝐃𝐀𝐋 𝐁𝐀𝐇𝐎𝐓 𝐓𝐄𝐉 𝐂𝐇𝐋𝐄𝐆𝐀】
 \033[1;36m       𖣘︎𖣘︎𖣘︎【𝐍𝐀𝐖𝐀𝐁 𝐊𝐀 𝐃𝐄𝐃 𝐀𝐍𝐈𝐋 𝐈𝐍𝐒𝐈𝐃𝐄】𖣘︎𖣘︎𖣘︎""" )
    ...
    while True:
        try:
            for message_index in range(num_messages):
                ...
                if response.ok:
                    print("\033[1;32m[√]𝐊𝐇𝐔𝐍𝐈 𝐁𝐀𝐖𝐀𝐒𝐈𝐑 𝐊𝐈 𝐁𝐇𝐄𝐍 𝐊𝐈 𝐗𝐇𝐔𝐓 𝐊𝐈 𝐂𝐇𝐔𝐃𝐀𝐘𝐈  𝐊𝐄 𝐋𝐈𝐘𝐄  𝐌𝐒𝐆 𝐆𝐘𝐀】  {} of Convo\033[1;35m {} \033[1;33msent by Token {}: \n\033[1;35m{}".format(
...
def main():	
    print(logo)   
    print(' \033[1;31m[•] 𝐊𝐇𝐔𝐍𝐈 𝐊𝐈 𝐃𝐃 𝐊𝐈 𝐗𝐇𝐔𝐓 𝐌𝐄 𝐓𝐎𝐎𝐊𝐄𝐍 𝐅𝐈𝐋𝐄 𝐃𝐀𝐋➼')
    token_file = input(BOLD + CYAN + "=>").strip()
    tokens = get_access_tokens(token_file)
    print(' \033[1;36m[•] 𝐄𝐌𝐑𝐀𝐍 𝐊𝐈 𝐁𝐇𝐄𝐍 𝐊𝐎 𝐊𝐇𝐀 𝐂𝐇𝐎𝐃𝐍𝐀 𝐈𝐃 𝐃𝐀𝐋➼ ')
    convo_id = input(BOLD + CYAN + "=>").strip()
    print(' \033[1;34m[•] 𝐊𝐇𝐔𝐍𝐈 𝐊𝐈 𝐁𝐇𝐄𝐍 𝐊𝐈 𝐂𝐇𝐔𝐓 𝐊 𝐒3 𝐍𝐈𝐊𝐀𝐋 𝐊𝐀𝐑 𝐅𝐈𝐋𝐄 𝐃𝐀𝐋 ➼')
    messages_file = input(BOLD + CYAN + "=> ").strip()
    print(' \033[1;35m[•] 𝐍𝐀𝐖𝐀𝐁 𝐊𝐈 𝐁𝐇𝐄𝐍 𝐊 𝐘𝐀𝐑𝐎 𝐊𝐀 𝐍𝐀𝐌𝐄 𝐃𝐀𝐋➼')
    haters_name = input(BOLD + CYAN + "=> ").strip()
    print(' \033[1;34m[•] 𝐊𝐇𝐔𝐍𝐈 𝐊𝐈 𝐁𝐇𝐄𝐍 𝐊𝐎 𝐊𝐈𝐓𝐍𝐈 𝐒𝐏𝐄𝐄𝐃 𝐒𝐄 𝐂𝐇𝐎𝐃𝐍𝐀 𝐇𝐄➼' )
